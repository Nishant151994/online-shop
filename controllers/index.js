...
module.exports = {
  ...
  async landingPage(req, res, next) {
    ...
    res.render('index', { posts, mapBoxToken, recentPosts, title: 'Online Shop - Home' });
  },
  // GET /register
  ...
  // POST /register
	async postRegister(req, res, next){
      try {
        ...
        req.session.success = `Welcome to Online Shop, ${ user.username }!`;
        res.redirect('/');
      });  
      } catch(err) {
  ...
  async putForgotPw(req, res, next) {
    ...
    const msg = {
      to: email,
      from: 'Online Shop Admin <foremailsendgrid@gmail.com>',
      subject: 'Online Shop - Forgot Password / Reset',
  ...
  const msg = {
    to: user.email,
    from: 'Online Shop Admin <foremailsendgrid@gmail.com>',
    subject: 'Online Shop - Password Changed',
    text: `Hello,
